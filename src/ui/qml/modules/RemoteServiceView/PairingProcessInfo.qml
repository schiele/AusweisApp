...
ColumnLayout {
	...
	Repeater {
		model: [
			//: ALL_PLATFORMS Assistance text for pairing new devices. Step 1 of 5. %1 is a placeholder for the app name. %2 is a version placeholder. %3 and %4 are for bold formatting.
			...
			//: ALL_PLATFORMS Assistance text for pairing new devices. Step 2 of 5. %1 and %2 are for bold formatting.
			qsTr("Connect both devices to the %1same network%2, e.g. via WLAN.").arg("<b>").arg("</b>"),
			//: ALL_PLATFORMS Assistance text for pairing new devices. Step 3 of 5. %1 and %2 are for bold formatting.
			...
			//: ALL_PLATFORMS Assistance text for pairing new devices. Step 4 of 5. %1 and %2 are for bold formatting.
			qsTr("Then select %1Pair (new) device%2. You may need to activate NFC first.").arg("<b>").arg("</b>"),
			//: ALL_PLATFORMS Assistance text for pairing new devices. Step 5 of 5
