...
if(PACKAGES)
	...
	if($ENV{USE_DISTRIBUTION_PROFILE})
		set(symbol_suffix "-appstore")
	endif()
	step(${CMAKE_COMMAND} -E tar cf "../../${ARTIFACT_FILENAME}${symbol_suffix}.app.dSYM.zip" --format=zip AusweisApp.app.dSYM CHDIR ${T_BUILD_DIR}/src/MinSizeRel)
